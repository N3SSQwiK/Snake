...
## Purpose
Per-screen navigation contracts using a SCREEN_NAV registry, unified back dispatch for all input methods, focus recovery on input mode switch, and 2D grid navigation support.
## Requirements
